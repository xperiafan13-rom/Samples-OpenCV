#NBayes (Miguel Angel Sanchez Bravo)
...
classifier.train(matrix_data, responses_data)
...
for cnt in contornos:
    ...
    matrix_data2 = classifier.predict(matrix_data)
    cv2.drawContours(img,[cnt],0,(128, 255, 0), 3)
    print ("La pieza resaltada es", Clases[int(matrix_data2[0]-1)])
    veces = veces + 1
    cv2.imshow('img',img)
    cv2.waitKey(0)
